...
const Tarea = () => import('@/entities/tareams/tarea/tarea.vue');
const TareaUpdate = () => import('@/entities/tareams/tarea/tarea-update.vue');
const TareaDetails = () => import('@/entities/tareams/tarea/tarea-details.vue');
