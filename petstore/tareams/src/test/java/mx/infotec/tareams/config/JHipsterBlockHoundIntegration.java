package mx.infotec.tareams.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.infotec.tareams.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.infotec.tareams.security.DomainUserDetailsService", "createSpringSecurityUser");
